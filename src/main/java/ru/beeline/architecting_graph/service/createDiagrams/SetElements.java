...
public class SetElements {
    ...
    public void setContextViewRelationships(String systemId, Relationship relationship,
            SystemContextView systemContextView, DiagramParameters diagramParameters) {
