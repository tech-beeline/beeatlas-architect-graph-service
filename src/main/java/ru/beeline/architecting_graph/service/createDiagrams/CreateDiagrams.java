...
public class CreateDiagrams {
    ...
    public static Boolean isContainerExists(Session session, String softwareSystemMnemonic,
    ...
    public static Boolean isEnvironmentExists(Session session, String environment) {
    ...
    public static ResponseEntity<String> createDiagram(RestConfig autorization, String softwareSystemMnemonic,
        ...
        if (exists) {
            ...
            if (containerMnemonic != null
                    && !isContainerExists(session, softwareSystemMnemonic, containerMnemonic)) {
            ...
            if (environment != null
                    && !isEnvironmentExists(session, environment)) {
