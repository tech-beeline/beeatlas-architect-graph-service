...
public class GraphUpdateFunctions {
    ...
    public void createGraph(String graphTag, Workspace workspace){
        ...
        if(Objects.isNull(model.getProperties().get("workspace_cmdb"))){
            throw new ValidationException("значению workspace_cmdb не соответствует ни один из SoftwareSystem");
        }
